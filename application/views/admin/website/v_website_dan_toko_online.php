			...
			<div class="inner-content">
				...
				<div class="slider-wrapper">
					...
					<?php foreach ($portofolio as $key => $value): ?>
						<div class="modal fade" tabindex="-1" id="portofolioedit<?php echo $key ?>">
							<div class="modal-dialog modal-dialog-centered">
								<div class="modal-content">
									<form action="<?php echo admin_url('website/layanan/website_dan_toko_online') ?>" method="POST" enctype="multipart/form-data">
						...
						<form action="<?php echo admin_url('website/layanan/website_dan_toko_online') ?>" method="POST">
