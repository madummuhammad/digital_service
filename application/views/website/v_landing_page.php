							...
							<div class="feedback_slider_three">
								<div class="item">
									<div class="block-wrapper">
										<img src="<?php echo base_url('') ?>assets/images/media/img_05.jpg" alt="" class="screen">
										<div class="overlay-content d-flex align-items-end">
											<a href="portfolio-detailsV2.html" class="d-flex justify-content-between align-items-center">
								...
								<div class="item">
									<div class="block-wrapper">
										<img src="<?php echo base_url('') ?>assets/images/media/img_06.jpg" alt="" class="screen">
										<div class="overlay-content d-flex align-items-end">
											<a href="portfolio-detailsV2.html" class="d-flex justify-content-between align-items-center">
								...
								<div class="item">
									<div class="block-wrapper">
										<img src="<?php echo base_url('') ?>assets/images/media/img_07.jpg" alt="" class="screen">
										<div class="overlay-content d-flex align-items-end">
											<a href="portfolio-detailsV2.html" class="d-flex justify-content-between align-items-center">
